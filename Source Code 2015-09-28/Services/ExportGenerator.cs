namespace ExcelWriter
{
    ...
    public sealed partial class ExportGenerator
    {
        ...
        ///// <param name="exportParameters">The export parameters.</param>
        ///// <returns></returns>
        //public string GenerateDocument(bool open, string title, IEnumerable<IDataPart> dataParts, DocumentMetadataBase metadata, ResourcePackage resourcePackage, ExportParameters exportParameters = null)
        //{
        //    if (string.IsNullOrEmpty(title))
        //    {
        ...
        //    {
        //        var stream = this.GenerateExcelInternal(exportParameters, (ExcelDocumentMetadata)metadata, dataParts, resourcePackage);
