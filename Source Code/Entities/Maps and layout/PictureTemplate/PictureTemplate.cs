namespace ExcelWriter
{
    ...
    /// <summary>
    /// Represents a definition for a picture template resource which can be used to create picture instances within an Excel document.
    /// </summary>
    public class PictureTemplate : BaseMap
    {
        ...
        /// <summary>
        /// Gets or sets the name of the picture in the DesignerFile where this picture template resides.
        /// </summary>
        /// <value>
        /// The name of the template picture.
        /// </value>
        public string TemplatePictureName
        {
            get { return this.templatePictureName; }
            set { this.templatePictureName = value; }
        }

        /// <summary>
        /// Gets or sets the name of the sheet in the DesignerFile where this picture template resides.
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Gets a value which indicates that this <see cref="PictureTemplate"/> is not visual, i.e. is never written into Exel
        /// </summary>
        ...
        {
            return base.GetContainerTypeWithKey("PictureTemplate");
        }
