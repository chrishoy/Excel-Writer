namespace ExcelWriter
{
    ...
    public class ExportMapService : IExportMapService
    {
        ...
        private bool isExcelDocumentMetaBased;
        ...
        private string PackSourceMetaDataFolder(string subFolderName)
        {
            ...
            string package = this.isExcelDocumentMetaBased 
                ? DocumentMetadataPackage.Pack(directory) 
                : ExportMetadataPackage.Pack(directory);
        ...
        private void WriteExportFiles()
        {
            ...
            this.WriteExportByteFiles(this.metadataFiles, metadataPath, this.isExcelDocumentMetaBased ? "TemplateFiles" : "TemplateFile");
